...
export class PoolChatbotStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    super(scope, id, props);
    // The code that defines your stack goes here
    const docsBucket = new s3.Bucket(this, "docsbucket", {
      bucketName: "ml-playground-docsbucket",
      lifecycleRules: [{
    ...
    new BucketDeployment(this, 'DeployDocFiles', {
    ...
    const lambdaQuery = new NodejsFunction(this, 'Query', {
      runtime: Runtime.NODEJS_20_X,
      entry: join(__dirname, '../lambda/query/index.ts'),
